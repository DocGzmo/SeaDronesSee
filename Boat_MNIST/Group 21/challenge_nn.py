"""
TODO
- team member 1: Fabian_Sperber
- team member 2: Kevin_Bertoletti
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 10, 10, 1, 5)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(10, 6, 3, 1, 1)
        self.fc1 = nn.Linear(6 * 48 * 27, 1500)
        self.fc2 = nn.Linear(1500, 120)
        self.fc3 = nn.Linear(120, 64)
        self.fc4 = nn.Linear(64, 1)

        # self.fc1 = nn.Linear(3 * 192 * 108, 1) Original
...
def main():
    ...
    path_to_dataset = "."   # TODO Set correct path
